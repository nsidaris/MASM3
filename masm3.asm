...
; Call method
	...
	push OFFSET strTest2				;Pass Param1
	call String_length						;Call method
	add ESP,4								;Repair stack
	mov [dReturnedVal],EAX					;Store returned Values
	Invoke intasc32, ADDR strOutput, dReturnedVal
	...
	push OFFSET strTest3				;Pass Param1
	call String_length						;Call method
	add ESP,4								;Repair stack
	mov [dReturnedVal],EAX					;Store returned Values
	Invoke intasc32, ADDR strOutput, dReturnedVal
	...
	push OFFSET strTest4				;Pass Param1
	call String_length						;Call method
	add ESP,4								;Repair stack
	mov [dReturnedVal],EAX					;Store returned Values
	Invoke intasc32, ADDR strOutput, dReturnedVal
...
TestString_equals PROC USES EAX ECX ESI EDI
	...
	push OFFSET strTest1   ;push last parameter first 
	push OFFSET strTest1
	call String_equals
	add ESP, 8
	mov [dReturnedVal],EAX	
	...
	push OFFSET strTest3   ;push last parameter first 
	push OFFSET strTest4
	call String_equals
	add ESP, 8
	mov [dReturnedVal],EAX	
	;Invoke putString, EAX
...
TestString_copy PROC USES EAX ECX ESI EDI
	...
	push OFFSET strTest4		;empty string
	call String_copy
	add esp, 4
	mov [dReturnedVal],EAX	
	Invoke putString, ADDR strNewline
